...
public class Period {
    ...
    public Period(int start, int end) {
        if (start >= end) {
            throw new IllegalArgumentException("start period cannot be after or the same as the end of period");
        }
        if (start < 0 || start > 24 || end < 0 || end > 24) {
            throw new IllegalArgumentException("start period and end of period must be between 0 and 23 and longer is out of scope");
        }
