...
<div class="container">
    <br <br <br <br <br><?php include("navBar.php"); ?>
    <meta http-equiv="refresh" content="900;url=/secure_app/logout.php"/>
    <article><p>Hello <a class="navbar-brand" href="#"> <?php echo "$login_session"; ?></a>
        <h2> This is Project 1 Page 2 AUTHENTICATED </h2></p>
